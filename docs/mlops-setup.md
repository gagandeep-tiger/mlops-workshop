...
git add README.md docs .gitignore dbx_workshop/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-3605952270900347.7.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-2769527762619333.13.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[dbx_workshop/databricks.yml](../dbx_workshop/databricks.yml) file.
...
Follow the instructions in [dbx_workshop/resources/README.md](../dbx_workshop/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../dbx_workshop/resources/README.md)  to propose, test, and deploy
