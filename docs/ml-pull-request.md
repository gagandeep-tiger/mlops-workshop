...
Opening a pull request will trigger a[workflow](../.github/workflows/dbx_workshop-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-3605952270900347.7.azuredatabricks.net/explore/data/models/staging/dbx_workshop/dbx_workshop-model)
* [Prod model in UC](https://adb-2769527762619333.13.azuredatabricks.net/explore/data/models/prod/dbx_workshop/dbx_workshop-model)
. 
