...
# ``dbx_workshop/resources/model-workflow-resource.yml``
#
# Parameters:
...
dbutils.widgets.text(
    "model_name", "dev.dbx_workshop.dbx_workshop-model", label="Full (Three-Level) Model Name"
)
